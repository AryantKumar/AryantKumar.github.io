    ...
    return Container(
      ...
      child: isBackground
          ...
          : <Widget>[
              ...
              TypeRichText(
                text: TextSpan(
                  text: 'Developing an app for your life... \n\n',
                  ...
                  children: <TextSpan>[
                    ...
                    const TextSpan(
                      text: '> Error: Not compatible with Android 11, please upgrade your OS!\n\n',
                      style: TextStyle(
                        color: kRed,
                      ),
                    ),
                    const TextSpan(
                      text: "> If you're on iOS, please update to the latest version to make your life meaningful!",
                      style: TextStyle(
                        color: kRed,
                      ),
                    ),
